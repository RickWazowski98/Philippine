...
def get_data_condo(url):
    try:
        ...
        result = {
            ...
            'start_from': start_from, # Lowest rent
            'sqm': sqm,
            'lowest_ask_price': lowest_ask_price,
            'sqm_ask': sqm_ask,
            'median_rent_price_sqm': median_rent_price_sqm,
            'median_sale_price_sqm': median_sale_price_sqm,
            'earliest_median_sale_price_sqm': earliest_median_sale_price_sqm,
            ...
            'part2_28_09-2': check_outlier(s_av_rent,6500,80000),
            'part2_28_09-3': check_outlier(s_av_ask_price,919500),
            'part2_28_09-4': bd1_n_of_units_for_rent,
            'part2_28_09-5': check_outlier(bd1_av_rent,8000,100000),
            'part2_28_09-6': check_outlier(bd1_av_ask_price,1125000),
            'part2_28_09-7': bd2_n_of_units_for_rent,
            'part2_28_09-8': check_outlier(bd2_av_rent,9500),
            'part2_28_09-9': check_outlier(bd2_av_ask_price,1100000),
            'part2_28_09-10': bd3_n_of_units_for_rent,
            'part2_28_09-11': check_outlier(bd3_av_rent,21000),
            'part2_28_09-12': check_outlier(bd3_av_ask_price,2198150),
            'part2_28_09-13': bd4_n_of_units_for_rent,
            'part2_28_09-14': check_outlier(bd4_av_rent,15000),
            'part2_28_09-15': check_outlier(bd4_av_ask_price,4098000),
            'earliest_median_rent_price_sqm': earliest_median_rent_price_sqm,
        ...
        result_gps_and_others_13_02_20 = {
            ...
            'bd4_n_of_units_for_sale': bd4_n_of_units_for_sale
        }
        print('result_gps_and_others_13_02_20', result_gps)

        return result, result_gps_and_others_13_02_20
...
def resolve_graph_link(url_project):
    if '/condo/' in url_project:
        ...
        url = 'https://www.dotproperty.com.ph/market-stats/project-page/condo/?key={}'.format(id)
        return url
...
if __name__ == "__main__":
    # get_data_condo('https://www.dotproperty.com.ph/condo/10063/32-sanson-byrockwell')
    # get_data_condo('https://www.dotproperty.com.ph/condo/11278/calyx-residences')
    # get_data_graph('https://www.dotproperty.com.ph/market-stats/project-page/condo/?key=10063')
    # get_data_graph('https://www.dotproperty.com.ph/market-stats/project-page/condo/?key=659')
    # get_data_projects('https://www.dotproperty.com.ph/condos/all/cebu')
    ...
    for link in links:
        print(link)
        result_project, result_project_gps = get_data_condo(link)
        if result_project:
        ...
        if result_project_gps:
            result_gps.append(result_project_gps)
        # else:
        #     result_gps.append(result_project_gps)

            file_object = open('data/projects_data_gps_and_others.json', 'w')
            json.dump(result_gps, file_object, indent=4)
