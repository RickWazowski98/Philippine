...
SHEET_NAME = 'Developers - Real Estate Data'
...
def scrape_developers_country(tab):
    ...
    try:
        ...
        print(f'alphabets_links: {alphabets_links}')

        for alphabets_link in alphabets_links:
            ...
            while next_page_url != None:
                ...
                try:
                    ...
                    next_page_url = f'{alphabets_link}{next_page}'
                except:
                    next_page_url = None
