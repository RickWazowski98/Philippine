...
file_object = open('data/projects_data_th_condo_result_bulk_1.json', 'r')
...
file_object = open('data/projects_data_th_condo_result_bulk_2.json', 'r')
projects_data = json.load(file_object)
...
file_object = open('data/projects_data_th_condo_result_bulk_3.json', 'r')
projects_data = json.load(file_object)
