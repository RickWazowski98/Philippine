...
file_object = open('data/provinces-cities-areas_urls_th_houses.json', 'w')
...
if __name__ == "__main__":
    file_object = open('data/provinces-cities-areas_urls_th_houses.json', 'r')
    ...
    file_object = open('data/provinces-cities-areas_data_th_houses.json', 'w')
    json.dump(result, file_object, indent=4)

    # LOAD
    file_object = open('data/provinces-cities-areas_data_th_houses.json', 'r')
